...
class NodeRenderer {
  ...
  drawNodeShape(ctx, x, y, width, height, scale, nodeStyle, opacity = 1.0, node = null) {
    ...
    const isDarkMode = document.documentElement.getAttribute('data-theme') === 'dark';
    const nodeData = {"ingest_pipeline": {"type": "start", "class_name": "PipelineHealthFlow"}, "run_analysis_crew": {"type": "listen", "class_name": "PipelineHealthFlow", "trigger_condition_type": "OR", "condition_type": "OR", "trigger_methods": ["ingest_pipeline"]}, "triage": {"type": "router", "class_name": "PipelineHealthFlow", "is_router": true, "trigger_condition_type": "OR", "condition_type": "OR", "trigger_methods": ["run_analysis_crew"]}, "run_advisory_crew": {"type": "listen", "class_name": "PipelineHealthFlow", "trigger_condition_type": "OR", "condition_type": "OR", "trigger_methods": ["escalate"]}, "human_review": {"type": "listen", "class_name": "PipelineHealthFlow", "trigger_condition_type": "OR", "condition_type": "OR", "trigger_methods": ["run_advisory_crew"]}, "publish": {"type": "listen", "class_name": "PipelineHealthFlow", "trigger_condition_type": "OR", "condition_type": "OR", "trigger_methods": ["human_review"]}, "log_healthy_pipeline": {"type": "listen", "class_name": "PipelineHealthFlow", "trigger_condition_type": "OR", "condition_type": "OR", "trigger_methods": ["summarize"]}};
...
class NetworkManager {
  ...
  async initialize() {
    try {
      ...
      this.nodes = new vis.DataSet([{"id": "ingest_pipeline", "label": "ingest_pipeline", "title": "\n            <div style=\"border-bottom: 1px solid rgba(102,102,102,0.15); padding-bottom: 8px; margin-bottom: 10px;\">\n                <div style=\"font-size: 13px; font-weight: 700; color: #333333; margin-bottom: 6px;\">ingest_pipeline</div>\n                <span style=\"display: inline-block; background: #FF5A50; color: white; padding: 2px 8px; border-radius: 4px; font-size: 10px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px;\">start</span>\n            </div>\n        ", "shape": "custom", "size": 30, "level": 0, "nodeStyle": {"name": "ingest_pipeline", "bgColor": "var(--node-bg-start)", "borderColor": "var(--node-border-start)", "borderWidth": 3, "fontColor": "var(--node-text-color)"}, "opacity": 1.0, "glowSize": 0, "glowColor": null}, {"id": "run_analysis_crew", "label": "run_analysis_crew", "title": "\n            <div style=\"border-bottom: 1px solid rgba(102,102,102,0.15); padding-bottom: 8px; margin-bottom: 10px;\">\n                <div style=\"font-size: 13px; font-weight: 700; color: #333333; margin-bottom: 6px;\">run_analysis_crew</div>\n                <span style=\"display: inline-block; background: #333333; color: white; padding: 2px 8px; border-radius: 4px; font-size: 10px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px;\">listen</span>\n            </div>\n        \n                <div style=\"margin-bottom: 8px;\">\n                    <div style=\"font-size: 10px; text-transform: uppercase; color: #666666; letter-spacing: 0.5px; margin-bottom: 3px; font-weight: 600;\">Condition</div>\n                    <span style=\"display: inline-block; background: rgba(102,102,102,0.12); color: #666666; padding: 3px 8px; border-radius: 4px; font-size: 11px; font-weight: 700;\">OR</span>\n                </div>\n            \n                <div style=\"margin-bottom: 8px;\">\n                    <div style=\"font-size: 10px; text-transform: uppercase; color: #666666; letter-spacing: 0.5px; margin-bottom: 4px; font-weight: 600;\">Triggers</div>\n                    <ul style=\"list-style: none; padding: 0; margin: 0;\"><li style=\"margin: 3px 0;\"><code style=\"background: rgba(102,102,102,0.08); padding: 2px 6px; border-radius: 3px; font-size: 10px; color: #333333; border: 1px solid rgba(102,102,102,0.12);\">ingest_pipeline</code></li></ul>\n                </div>\n            ", "shape": "custom", "size": 30, "level": 1, "nodeStyle": {"name": "run_analysis_crew", "bgColor": "var(--node-bg-listen)", "borderColor": "var(--node-border-listen)", "borderWidth": 3, "fontColor": "var(--node-text-color)"}, "opacity": 1.0, "glowSize": 0, "glowColor": null}, {"id": "triage", "label": "triage", "title": "\n            <div style=\"border-bottom: 1px solid rgba(102,102,102,0.15); padding-bottom: 8px; margin-bottom: 10px;\">\n                <div style=\"font-size: 13px; font-weight: 700; color: #333333; margin-bottom: 6px;\">triage</div>\n                <span style=\"display: inline-block; background: #FF5A50; color: white; padding: 2px 8px; border-radius: 4px; font-size: 10px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px;\">router</span>\n            </div>\n        \n                <div style=\"margin-bottom: 8px;\">\n                    <div style=\"font-size: 10px; text-transform: uppercase; color: #666666; letter-spacing: 0.5px; margin-bottom: 3px; font-weight: 600;\">Condition</div>\n                    <span style=\"display: inline-block; background: rgba(102,102,102,0.12); color: #666666; padding: 3px 8px; border-radius: 4px; font-size: 11px; font-weight: 700;\">OR</span>\n                </div>\n            \n                <div style=\"margin-bottom: 8px;\">\n                    <div style=\"font-size: 10px; text-transform: uppercase; color: #666666; letter-spacing: 0.5px; margin-bottom: 4px; font-weight: 600;\">Triggers</div>\n                    <ul style=\"list-style: none; padding: 0; margin: 0;\"><li style=\"margin: 3px 0;\"><code style=\"background: rgba(102,102,102,0.08); padding: 2px 6px; border-radius: 3px; font-size: 10px; color: #333333; border: 1px solid rgba(102,102,102,0.12);\">run_analysis_crew</code></li></ul>\n                </div>\n            ", "shape": "custom", "size": 30, "level": 2, "nodeStyle": {"name": "triage", "bgColor": "var(--node-bg-router)", "borderColor": "#FF5A50", "borderWidth": 3, "fontColor": "var(--node-text-color)"}, "opacity": 1.0, "glowSize": 0, "glowColor": null}, {"id": "run_advisory_crew", "label": "run_advisory_crew", "title": "\n            <div style=\"border-bottom: 1px solid rgba(102,102,102,0.15); padding-bottom: 8px; margin-bottom: 10px;\">\n                <div style=\"font-size: 13px; font-weight: 700; color: #333333; margin-bottom: 6px;\">run_advisory_crew</div>\n                <span style=\"display: inline-block; background: #333333; color: white; padding: 2px 8px; border-radius: 4px; font-size: 10px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px;\">listen</span>\n            </div>\n        \n                <div style=\"margin-bottom: 8px;\">\n                    <div style=\"font-size: 10px; text-transform: uppercase; color: #666666; letter-spacing: 0.5px; margin-bottom: 3px; font-weight: 600;\">Condition</div>\n                    <span style=\"display: inline-block; background: rgba(102,102,102,0.12); color: #666666; padding: 3px 8px; border-radius: 4px; font-size: 11px; font-weight: 700;\">OR</span>\n                </div>\n            \n                <div style=\"margin-bottom: 8px;\">\n                    <div style=\"font-size: 10px; text-transform: uppercase; color: #666666; letter-spacing: 0.5px; margin-bottom: 4px; font-weight: 600;\">Triggers</div>\n                    <ul style=\"list-style: none; padding: 0; margin: 0;\"><li style=\"margin: 3px 0;\"><code style=\"background: rgba(102,102,102,0.08); padding: 2px 6px; border-radius: 3px; font-size: 10px; color: #333333; border: 1px solid rgba(102,102,102,0.12);\">escalate</code></li></ul>\n                </div>\n            ", "shape": "custom", "size": 30, "level": 0, "nodeStyle": {"name": "run_advisory_crew", "bgColor": "var(--node-bg-listen)", "borderColor": "var(--node-border-listen)", "borderWidth": 3, "fontColor": "var(--node-text-color)"}, "opacity": 1.0, "glowSize": 0, "glowColor": null}, {"id": "human_review", "label": "human_review", "title": "\n            <div style=\"border-bottom: 1px solid rgba(102,102,102,0.15); padding-bottom: 8px; margin-bottom: 10px;\">\n                <div style=\"font-size: 13px; font-weight: 700; color: #333333; margin-bottom: 6px;\">human_review</div>\n                <span style=\"display: inline-block; background: #333333; color: white; padding: 2px 8px; border-radius: 4px; font-size: 10px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px;\">listen</span>\n            </div>\n        \n                <div style=\"margin-bottom: 8px;\">\n                    <div style=\"font-size: 10px; text-transform: uppercase; color: #666666; letter-spacing: 0.5px; margin-bottom: 3px; font-weight: 600;\">Condition</div>\n                    <span style=\"display: inline-block; background: rgba(102,102,102,0.12); color: #666666; padding: 3px 8px; border-radius: 4px; font-size: 11px; font-weight: 700;\">OR</span>\n                </div>\n            \n                <div style=\"margin-bottom: 8px;\">\n                    <div style=\"font-size: 10px; text-transform: uppercase; color: #666666; letter-spacing: 0.5px; margin-bottom: 4px; font-weight: 600;\">Triggers</div>\n                    <ul style=\"list-style: none; padding: 0; margin: 0;\"><li style=\"margin: 3px 0;\"><code style=\"background: rgba(102,102,102,0.08); padding: 2px 6px; border-radius: 3px; font-size: 10px; color: #333333; border: 1px solid rgba(102,102,102,0.12);\">run_advisory_crew</code></li></ul>\n                </div>\n            ", "shape": "custom", "size": 30, "level": 0, "nodeStyle": {"name": "human_review", "bgColor": "var(--node-bg-listen)", "borderColor": "var(--node-border-listen)", "borderWidth": 3, "fontColor": "var(--node-text-color)"}, "opacity": 1.0, "glowSize": 0, "glowColor": null}, {"id": "publish", "label": "publish", "title": "\n            <div style=\"border-bottom: 1px solid rgba(102,102,102,0.15); padding-bottom: 8px; margin-bottom: 10px;\">\n                <div style=\"font-size: 13px; font-weight: 700; color: #333333; margin-bottom: 6px;\">publish</div>\n                <span style=\"display: inline-block; background: #333333; color: white; padding: 2px 8px; border-radius: 4px; font-size: 10px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px;\">listen</span>\n            </div>\n        \n                <div style=\"margin-bottom: 8px;\">\n                    <div style=\"font-size: 10px; text-transform: uppercase; color: #666666; letter-spacing: 0.5px; margin-bottom: 3px; font-weight: 600;\">Condition</div>\n                    <span style=\"display: inline-block; background: rgba(102,102,102,0.12); color: #666666; padding: 3px 8px; border-radius: 4px; font-size: 11px; font-weight: 700;\">OR</span>\n                </div>\n            \n                <div style=\"margin-bottom: 8px;\">\n                    <div style=\"font-size: 10px; text-transform: uppercase; color: #666666; letter-spacing: 0.5px; margin-bottom: 4px; font-weight: 600;\">Triggers</div>\n                    <ul style=\"list-style: none; padding: 0; margin: 0;\"><li style=\"margin: 3px 0;\"><code style=\"background: rgba(102,102,102,0.08); padding: 2px 6px; border-radius: 3px; font-size: 10px; color: #333333; border: 1px solid rgba(102,102,102,0.12);\">human_review</code></li></ul>\n                </div>\n            ", "shape": "custom", "size": 30, "level": 0, "nodeStyle": {"name": "publish", "bgColor": "var(--node-bg-listen)", "borderColor": "var(--node-border-listen)", "borderWidth": 3, "fontColor": "var(--node-text-color)"}, "opacity": 1.0, "glowSize": 0, "glowColor": null}, {"id": "log_healthy_pipeline", "label": "log_healthy_pipeline", "title": "\n            <div style=\"border-bottom: 1px solid rgba(102,102,102,0.15); padding-bottom: 8px; margin-bottom: 10px;\">\n                <div style=\"font-size: 13px; font-weight: 700; color: #333333; margin-bottom: 6px;\">log_healthy_pipeline</div>\n                <span style=\"display: inline-block; background: #333333; color: white; padding: 2px 8px; border-radius: 4px; font-size: 10px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px;\">listen</span>\n            </div>\n        \n                <div style=\"margin-bottom: 8px;\">\n                    <div style=\"font-size: 10px; text-transform: uppercase; color: #666666; letter-spacing: 0.5px; margin-bottom: 3px; font-weight: 600;\">Condition</div>\n                    <span style=\"display: inline-block; background: rgba(102,102,102,0.12); color: #666666; padding: 3px 8px; border-radius: 4px; font-size: 11px; font-weight: 700;\">OR</span>\n                </div>\n            \n                <div style=\"margin-bottom: 8px;\">\n                    <div style=\"font-size: 10px; text-transform: uppercase; color: #666666; letter-spacing: 0.5px; margin-bottom: 4px; font-weight: 600;\">Triggers</div>\n                    <ul style=\"list-style: none; padding: 0; margin: 0;\"><li style=\"margin: 3px 0;\"><code style=\"background: rgba(102,102,102,0.08); padding: 2px 6px; border-radius: 3px; font-size: 10px; color: #333333; border: 1px solid rgba(102,102,102,0.12);\">summarize</code></li></ul>\n                </div>\n            ", "shape": "custom", "size": 30, "level": 0, "nodeStyle": {"name": "log_healthy_pipeline", "bgColor": "var(--node-bg-listen)", "borderColor": "var(--node-border-listen)", "borderWidth": 3, "fontColor": "var(--node-text-color)"}, "opacity": 1.0, "glowSize": 0, "glowColor": null}]);
      this.edges = new vis.DataSet([{"from": "ingest_pipeline", "to": "run_analysis_crew", "label": "OR", "arrows": "to", "width": 2, "selectionWidth": 0, "color": {"color": "#666666", "highlight": "#666666"}}, {"from": "run_analysis_crew", "to": "triage", "label": "OR", "arrows": "to", "width": 2, "selectionWidth": 0, "color": {"color": "#666666", "highlight": "#666666"}}, {"from": "run_advisory_crew", "to": "human_review", "label": "OR", "arrows": "to", "width": 2, "selectionWidth": 0, "color": {"color": "#666666", "highlight": "#666666"}}, {"from": "human_review", "to": "publish", "label": "OR", "arrows": "to", "width": 2, "selectionWidth": 0, "color": {"color": "#666666", "highlight": "#666666"}}]);
  ...
  setupExportControls() {
    ...
    //   const dagData = {"nodes": {"ingest_pipeline": {"type": "start", "class_name": "PipelineHealthFlow"}, "run_analysis_crew": {"type": "listen", "class_name": "PipelineHealthFlow", "trigger_condition_type": "OR", "condition_type": "OR", "trigger_methods": ["ingest_pipeline"]}, "triage": {"type": "router", "class_name": "PipelineHealthFlow", "is_router": true, "trigger_condition_type": "OR", "condition_type": "OR", "trigger_methods": ["run_analysis_crew"]}, "run_advisory_crew": {"type": "listen", "class_name": "PipelineHealthFlow", "trigger_condition_type": "OR", "condition_type": "OR", "trigger_methods": ["escalate"]}, "human_review": {"type": "listen", "class_name": "PipelineHealthFlow", "trigger_condition_type": "OR", "condition_type": "OR", "trigger_methods": ["run_advisory_crew"]}, "publish": {"type": "listen", "class_name": "PipelineHealthFlow", "trigger_condition_type": "OR", "condition_type": "OR", "trigger_methods": ["human_review"]}, "log_healthy_pipeline": {"type": "listen", "class_name": "PipelineHealthFlow", "trigger_condition_type": "OR", "condition_type": "OR", "trigger_methods": ["summarize"]}}, "edges": [{"source": "ingest_pipeline", "target": "run_analysis_crew", "condition_type": "OR", "is_router_event": false}, {"source": "run_analysis_crew", "target": "triage", "condition_type": "OR", "is_router_event": false}, {"source": "run_advisory_crew", "target": "human_review", "condition_type": "OR", "is_router_event": false}, {"source": "human_review", "target": "publish", "condition_type": "OR", "is_router_event": false}], "start_methods": ["ingest_pipeline"], "router_methods": ["triage"]};
